...
const ToastNotification = () => {
    ...
    return (
        <div
            className={`toast fixed top-10 right-0 md:right-10 w-[22rem] h-24 bg-gray-300 overflow-hidden z-[1000] before:absolute before:inset-0 before:blur-sm before:bg-white before:z-[-1] ${
